 ...
 * WooCommerceProductGallery module,
...
class WooCommerceProductGalleryModule implements DependencyInterface {
							...
							'children'          => [
								HTMLUtility::render(
									[
										'tag'        => 'h1',
										'tagEscaped' => true,
										'children'   => 'Module: Woo Product Gallery',
									]
								),
								HTMLUtility::render(
									[
	 ...
	 * );
	 *
	 * WooCommerceProductGalleryModule::module_script_data( $args );
	 * ```
	 */
	...
	public static function custom_css(): array {
		$registered_block = WP_Block_Type_Registry::get_instance()->get_registered( 'divi/woocommerce-product-gallery' );

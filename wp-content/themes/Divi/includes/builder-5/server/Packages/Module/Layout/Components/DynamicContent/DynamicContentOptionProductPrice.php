...
class DynamicContentOptionProductPrice extends DynamicContentOptionBase implements DynamicContentOptionInterface {
	...
	public function register_option_callback( array $options, int $post_id, string $context ): array {
		...
		if ( ! isset( $options[ 'loop_' . $this->get_name() ] ) && et_is_woocommerce_plugin_active() ) {
			...
			$options[ 'loop_regular_' . $this->get_name() ] = [
				'id'     => 'loop_regular_' . $this->get_name(),
			...
			$options[ 'loop_sale_' . $this->get_name() ] = [
				'id'     => 'loop_sale_' . $this->get_name(),
			...
			$options[ 'loop_current_' . $this->get_name() ] = [
				'id'     => 'loop_current_' . $this->get_name(),

...
if ( ! defined( 'ET_BUILDER_PRODUCT_VERSION' ) ) {
	...
	define( 'ET_BUILDER_PRODUCT_VERSION', '5.0.0-public-alpha.17' );
}
...
function et_fb_current_page_params() {
	...
	// Get post type label.
	$post_type_label = $post_type_object ? get_post_type_labels( $post_type_object )->singular_name : ucfirst( $post->post_type );
